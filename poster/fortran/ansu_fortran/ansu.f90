...
contains
    ...
    subroutine dz_from_drho(sns, ctns, pns, s, ct, p, drho)
		...
		call cpu_time ( tend )
		write ( *, * ) 'Elapsed CPU time = ', tend-tstart
    ...
    subroutine solve_lsqr(regions,drhox,drhoy,drho)
        ...
        integer :: itnlim=3775 ! max. number of iterations
        ...
        do ireg=1,nregions
            ...
            call cpu_time ( tend )
            write ( *, * ) 'Elapsed CPU time: ', tend-tstart
            write ( *, * ) 'Number of iterations: ', itn
            deallocate(y)
